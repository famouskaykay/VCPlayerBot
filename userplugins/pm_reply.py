...
async def reply(client, message): 
    try:
        inline = await client.get_inline_bot_results(Config.BOT_USERNAME, "xkaykaybot")
        ...
        await message.reply(f"{Config.REPLY_MESSAGE}\n\n<b>You can't use this bot in your group, for that you have to purchase your own bot [PURCHASE BOT ](https://t.me/famouskaykay3) below.</b>", disable_web_page_preview=True)

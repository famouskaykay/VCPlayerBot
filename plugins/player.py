...
async def not_chat(_, m: Message):
    buttons = [
        [
            InlineKeyboardButton('⚡️GET your own bot', url='https://t.me/famouskaykay3'),
            InlineKeyboardButton('🧩 Join Here', url='https://t.me/KayAspirerProject'),
        ]
        ]
    await m.reply("<b>You can't use this bot in this group [DEVELOPER](https://t.me/famouskaykay3) below.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))

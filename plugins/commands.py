...
async def start(client, message):
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/KayAspirerProject'))
        ],
        [
...
async def show_help(client, message):
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/KayAspirerProject'),
            InlineKeyboardButton('🧩 Source', url='https://t.me/fmouskaykay3'),
        ]
        ]
    reply_markup = InlineKeyboardMarkup(buttons)
...
async def repo_(client, message):
    ...
    await message.reply(" 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons))
